...
public sealed class ProjectActionEventArgs : EventArgs
{
    public ProjectActionEventArgs(string action, ProjectDescriptor project) { Action = action; Project = project; }
...
public partial class ProjectHubWindow : Window
{
    ...
    public ProjectHubWindow(AppSettings settings)
    {
        _settings = settings;
        InitializeComponent();
        RootBadgeText.Text = Directory.Exists(settings.WorkspaceRoot) ? settings.WorkspaceRoot : "未配置工作区";
    ...
    private async Task RefreshAsync()
    {
        ...
        {
            App.Log("Project hub refresh failed: " + ex);
    ...
    private void CopyPath_Click(object sender, RoutedEventArgs e)
    {
        ...
        try { Clipboard.SetText(_selected.RootPath); StatusText.Text = "路径已复制 · " + _selected.RootPath; }
