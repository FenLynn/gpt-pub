...
/// <summary>
/// Final owner for the v1.1.11 sidebar and terminal visual corrections.
...
/// </summary>
public sealed class V1111VisualPolishCoordinator : IDisposable
{
    ...
    private V1111VisualPolishCoordinator(MainWindow window, WorkbenchFeaturePipeline pipeline)
    {
        _window = window;
        ...
        App.Log("v1.1.11 visual polish attached: project context moved to command row; terminal uses neutral black CMD chrome");
    }

    public static V1111VisualPolishCoordinator Attach(MainWindow window, WorkbenchFeaturePipeline pipeline)
        => new(window, pipeline);
