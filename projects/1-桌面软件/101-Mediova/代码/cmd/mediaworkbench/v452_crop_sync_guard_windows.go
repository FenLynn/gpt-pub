...
var (
	...
	v452CropSyncStates       sync.Map // map[uintptr]*v452CropSyncState, keyed by dialog HWND
	v452CropSyncParents      sync.Map // map[uintptr]bool
	v452CropSyncEdits        sync.Map // map[uintptr]bool
...
func v452InstallCropSyncGuard(d *trimDialog) {
	...
	if _, loaded := v452CropSyncParents.LoadOrStore(d.hwnd, true); !loaded {
		v452CropSyncStates.Store(d.hwnd, &v452CropSyncState{})
		v452SetWindowSubclass.Call(d.hwnd, v452CropSyncParentCB, v452CropSyncParentSubclassID, 0)
	}
