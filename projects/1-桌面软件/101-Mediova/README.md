...
- 当前活动推进与逐轮证据：[Mediova v4.5.2 工作记录](Mediova_v4.5.2_工作记录.md)
...
新对话必须先按 A｜`/GPT_RULES.md` → B｜`../开发约束.md` → C｜本项目 `开发约束.md` 读取约束，再读取本 README、阶段记录、v4.5.2 修复规格和 v4.5.2 工作记录。旧聊天记录只作为补充。
...
完整边界、设计原因和验证证据分别以 `开发约束.md`、`软件开发总结.md`、`阶段记录.md`、`Mediova_v4.5.2_实机反馈修复规格.md`、`Mediova_v4.5.2_工作记录.md` 与历史 `工作记录.md` 为准。
