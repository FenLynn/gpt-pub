...
export const mockSnapshot: DavBridgeSnapshot = {
  version: '0.4.2', cycleId: '260907', configured: true, engineState: '等待额度', routeStatus: '等待下一周期', routeTone: 'wait',
  phases: [
  ...
  quota: { uploadUsed: 946600000, uploadMax: 1000000000, uploadText: '946.6 MB / 1.00 GB', downloadUsed: 2090000000, downloadMax: 3000000000, downloadText: '2.09 GB / 3.00 GB', resetText: '2026-10-07 · 09:00 后探测', isSprint: false },
