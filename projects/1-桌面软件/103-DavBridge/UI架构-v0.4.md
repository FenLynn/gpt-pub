...
v0.4.11 位于 `p103-exp`，最后完成完整 CI 的代码 head 为 `3c9de7086438f5e8bff03d5ec71a5ac89befccae`，对应 run `34704232146`。它尚未提升到 `p103-stable` 或 `main`。

下一关是用户 Windows 实机验收，重点检查顶部路线、两端名称配色、图标居中、当前任务中央状态与进度，以及动作按钮的独立性。