...
internal sealed class MainForm : Form
{
    ...
    private static AppConfig CloneConfig(AppConfig source) => new()
    {
        ...
        Power1DisplayUnit = source.Power1DisplayUnit,
        Power2DisplayUnit = source.Power2DisplayUnit,
        Math1DisplayUnit = source.Math1DisplayUnit,
        Power1AxisMin = source.Power1AxisMin,
        Power1AxisMax = source.Power1AxisMax,
        Power2AxisMin = source.Power2AxisMin,
        Power2AxisMax = source.Power2AxisMax,
        Math1AxisMin = source.Math1AxisMin,
        Math1AxisMax = source.Math1AxisMax,
        ...
        ScopeActiveChannel = source.ScopeActiveChannel,
        ScopeCh1VoltsDiv = source.ScopeCh1VoltsDiv,
        ScopeCh1Offset = source.ScopeCh1Offset,
        ScopeCh1Coupling = source.ScopeCh1Coupling,
        ScopeCh2VoltsDiv = source.ScopeCh2VoltsDiv,
        ScopeCh2Offset = source.ScopeCh2Offset,
        ScopeCh2Coupling = source.ScopeCh2Coupling,
